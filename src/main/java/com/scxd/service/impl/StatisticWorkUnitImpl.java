...
import com.scxd.dao.StatisticWorkUnitDao;
import com.scxd.service.StatisticAssessCommonService;
import com.scxd.service.StatisticWorkUnit;
 ...
 * @Auther:陈攀
 * @Description:
 * @Date:Created in 15:41 2018/11/28
 * @Modified By:
 */
@Service
public class StatisticWorkUnitImpl implements StatisticWorkUnit {
    @Autowired
    StatisticWorkUnitDao statisticBase;
    @Autowired
    StatisticAssessCommonService assessCommonService;
    @Override
    public void statisticWork(String qyid, String qycj, AssessConfigBean assessConfigBean, Date khkssj, Date khjssj, int khlx, String uuid) {
        statisticBaseKH(qyid, qycj, assessConfigBean, khkssj, khjssj,khlx,uuid);
    }
     ...
     * @param khlx
     */
    private void statisticBaseKH(String qyid, String qycj, AssessConfigBean assessConfigBean, Date kssj, Date jssj, int khlx, String uuid) {
        ...
        try {
            List<StatisticQdzBean> list = statisticBase.getStatisticWork(qyid, qycj, kssj, jssj);
