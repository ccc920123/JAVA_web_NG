...
import com.scxd.dao.StatisticWorkHiddenDao;
import com.scxd.service.StatisticAssessCommonService;
import com.scxd.service.StatisticWorkHidden;
 ...
 */
@Service
public class StatisticWorkHiddenImpl implements StatisticWorkHidden {
    @Autowired
    StatisticWorkHiddenDao statisticBase;
    @Autowired
     ...
     * @param khlx
     */
    private void statisticBaseKH(String qyid, String qycj, AssessConfigBean assessConfigBean, Date kssj,
