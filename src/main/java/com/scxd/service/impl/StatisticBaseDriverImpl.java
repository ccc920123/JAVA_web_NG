...
import com.scxd.dao.StatisticBaseDriverDao;
import com.scxd.service.StatisticAssessCommonService;
import com.scxd.service.StatisticBaseDriver;
 ...
 */
@Service
public class StatisticBaseDriverImpl implements StatisticBaseDriver {
    @Autowired
    StatisticBaseDriverDao statisticBase;
    @Autowired
     ...
     * @param khlx
     */
    private void statisticBaseKH(String qyid, String qycj, AssessConfigBean assessConfigBean,
                                 Date kssj, Date jssj,
