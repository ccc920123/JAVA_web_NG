        ...
        var global={
            ...
            timeDot:function(){
                var $list=$('.ui-time-box'),
                    $dp0=$('#dp0'),
                    $dp1 = $('#dp1');
                $dp0.val(doTime(new Date()));
                $dp1.val(doTime(new Date()));
...
function toTime() {
    $("#nowtime").html(doTime(new Date()));
    window.setTimeout("toTime()", 1000);
}
$(function () {
    $("#dp11").val(doTime(new Date()) + ' ~ ' + doTime(new Date()));
    $("#dp11").attr("kssj", doTime(new Date()));
    $("#dp11").attr("jssj", doTime(new Date()));
});