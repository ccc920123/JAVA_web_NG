...
var templates = [
    {
        "pre":"pre0.png",
        'title':'新闻发布模板',
        'preHtml':'<p class="ue_t">新闻发布模板</p>',
        "html":'<h1 style="border-bottom-color:#cccccc;border-bottom-width:2px;border-bottom-style:solid;padding:0px 4px 0px 0px;text-align:center;margin:0px 0px 20px;">\n' +
        '    <span style="color: rgb(192, 80, 77); font-family: &quot;Microsoft YaHei&quot;; font-size: 26px; font-weight: 700; text-align: center; background-color: rgb(0, 0, 0);"></span><span style="font-family: &quot;Microsoft YaHei&quot;; font-size: 26px; font-weight: 700; text-align: center; background-color: rgb(255, 255, 255);">新闻发布模板</span>\n' +
        '</h1>\n' +
        '<p style="text-align:center;">\n' +
        '    <strong class="ue_t"></strong>\n' +
        '</p>\n' +
        '<p style="margin-top: 0px; margin-bottom: 0px; padding: 0px; font-family: &quot;Microsoft YaHei&quot;; font-size: 12px; white-space: normal; line-height: 2em; text-indent: 43px; background: white; text-align: center;">\n' +
        '    <span style="margin: 0px; padding: 0px; font-family: 宋体, SimSun; color: rgb(51, 51, 51); font-size: 18px;"><img src="./images/pre4.png" alt="Lighthouse.jpg" width="322" height="276"/></span>\n' +
        '</p>\n' +
        '<p style="margin-top: 0px; margin-bottom: 0px; padding: 0px; font-family: &quot;Microsoft YaHei&quot;; font-size: 12px; white-space: normal; line-height: 2em; text-indent: 43px; background: white; text-align: center;">\n' +
        '    <span style="margin: 0px; padding: 0px; font-family: 宋体, SimSun; color: rgb(51, 51, 51); font-size: 18px;"><img src="./images/pre3.png" alt="Lighthouse.jpg" width="322" height="276"/></span>\n' +
        '</p>\n' +
        '<p style="margin-top: 0px; margin-bottom: 0px; padding: 0px; font-family: &quot;Microsoft YaHei&quot;; font-size: 12px; white-space: normal; line-height: 2em; text-indent: 43px; background: white;">\n' +
        '    <span style="margin: 0px; padding: 0px; font-family: 宋体, SimSun; color: rgb(51, 51, 51); font-size: 18px;">这里填写内容：xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx</span>\n' +
        '</p>\n' +
        '<p style="margin-top: 0px; margin-bottom: 0px; padding: 0px; font-family: &quot;Microsoft YaHei&quot;; font-size: 12px; white-space: normal; line-height: 2em; text-indent: 43px; background: white;">\n' +
        '    <span style="margin: 0px; padding: 0px; font-family: 宋体, SimSun; color: rgb(51, 51, 51); font-size: 18px;">这里填写内容：xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx等违法行为查处。特别是学校开学在即，要加强学校周边道路交通秩序和接送学生车辆的管理，有针对性的调整勤务模式，在学校周边加派执勤警力，切实保障学生安全返校，全力以赴确保道路交通安全形势持续稳定。</span>\n' +
        '</p>\n' +
