...
(function () {
    ...
    function initButtons() {
        ...
        dialog.onok = function () {
            ...
            if (list) {
                var table = $("<span style=\"width:100%;text-align: center;\"></span>")
                var tr ;
                var td;
                $(list).each(function (index, item) {
                    ...
                    if (index % 2 == 0) {
                        if ((list.length- 1) == index ) {
                             tr = $("<p style=\"text-align: center;\"></p>");
                            $(tr).append($("<img width='400px' height='270px' src=\"" + item.src + "\" />"));
                            $(table).append($(tr));
                        } else {
                            tr = $("<p style=\"text-align: center;display:inline-block;width:100%\"></p>");
                            td = $("<span style=\"text-align:center;width: 48.5%;display:block;float:left\"></span>");
                            $(tr).append($(td));
                        ...
                        td = $("<span style=\"text-align:center;width: 48.5%;display:block;float:right\"></span>");
                        $(td).append($("<img width='400px' height='270px' src=\"" + item.src + "\" />"));
                        $(tr).append($(td));
                        $(table).append($(tr));
                    }
